...
const styles = StyleSheet.create({
  ...
  title: {
    color: Colors.gold, fontFamily: 'Inter_700Bold', fontSize: 14,
    letterSpacing: 3,
  },
  divider: { height: 1, backgroundColor: Colors.border, marginHorizontal: 16 },
  empty: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 40 },
  emptyTitle: { color: Colors.text, fontFamily: 'Inter_600SemiBold', fontSize: 18, marginBottom: 8 },
  emptyText: { color: Colors.textMuted, fontFamily: 'Inter_400Regular', fontSize: 14, textAlign: 'center' },
  ...
  recordResult: { fontFamily: 'Inter_700Bold', fontSize: 12, letterSpacing: 2 },
  win: { color: Colors.gold },
  loss: { color: Colors.textMuted },
  recordDate: { color: Colors.textMuted, fontFamily: 'Inter_400Regular', fontSize: 12 },
  recordName: { color: Colors.text, fontFamily: 'Inter_600SemiBold', fontSize: 16 },
  recordStats: { flexDirection: 'row', gap: 16, marginTop: 4 },
  stat: { alignItems: 'center' },
  statValue: { color: Colors.text, fontFamily: 'Inter_700Bold', fontSize: 16 },
