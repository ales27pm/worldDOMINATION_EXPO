...
const styles = StyleSheet.create({
  ...
  backBtn: { padding: 8 },
  backText: { color: Colors.gold, fontFamily: 'Inter_500Medium', fontSize: 14 },
  title: { color: Colors.gold, fontFamily: 'Inter_700Bold', fontSize: 14, letterSpacing: 3 },
  divider: { height: 1, backgroundColor: Colors.border, marginHorizontal: 16 },
  content: { padding: 16, gap: 24, paddingBottom: 40 },
  section: { gap: 10 },
  sectionTitle: {
    color: Colors.goldDim, fontFamily: 'Inter_600SemiBold', fontSize: 11,
  ...
  humanLabel: { color: Colors.textMuted, fontFamily: 'Inter_400Regular', fontSize: 12 },
  removeBtn: { padding: 4 },
  ...
  addBtnText: { color: Colors.textMuted, fontFamily: 'Inter_500Medium', fontSize: 14 },
  ...
  pickerOptText: { color: Colors.textMuted, fontFamily: 'Inter_500Medium', fontSize: 12 },
  ...
  switchLabel: { color: Colors.text, fontFamily: 'Inter_600SemiBold', fontSize: 14 },
  switchDesc: { color: Colors.textMuted, fontFamily: 'Inter_400Regular', fontSize: 12, marginTop: 2 },
  startBtn: {
    backgroundColor: Colors.gold, paddingVertical: 18, alignItems: 'center', marginTop: 8,
  },
  startBtnText: {
    color: Colors.bg, fontFamily: 'Inter_700Bold', fontSize: 16, letterSpacing: 3,
  },
});
